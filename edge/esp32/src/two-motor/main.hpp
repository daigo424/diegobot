...
// --- ピン定義 ---
// 左輪（Motor 1）
const int LEFT_ENC_A = 18;  // D18 (黄色)
const int LEFT_ENC_B = 19;  // D19 (緑色)

// 右輪（Motor 2）
const int RIGHT_ENC_A = 16; // RX2 (黄色)
const int RIGHT_ENC_B = 17; // TX2 (緑色)
...
// --- 割り込みハンドラ (左輪) ---
void IRAM_ATTR handle_left_encoder() {
...
// --- 割り込みハンドラ (右輪) ---
void IRAM_ATTR handle_right_encoder() {
